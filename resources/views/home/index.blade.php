...
<head>
    ...
    <meta charset="utf-8"/>
    <title>{!! site_option("site_title")!!}</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
    <link rel="icon" type="image/x-icon" href="{!!url('/')!!}/favicon.ico"/>
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-touch-fullscreen" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="default">
    <meta content="{!! site_option("site_description") !!}" name="description"/>
    <meta content="{!! site_option("site_author") !!}" name="author"/>
            ...
            <!-- START Form Control-->
                ...
                @if(\Session::has('success'))
                    <div class="alert alert-success">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                        <strong>{!! tr("messages.success") !!}!</strong> {!! \Session::get('success') !!}
                    </div>
                @endif
                <div class="btn-group btn-group-justified">
                    <a href="{!! url('login/twitter') !!}"
                       class="btn btn-success btn-xs">{!! tr("login_using_twitter") !!}</a>
                    <a href="{!!url('login/fb')!!}/#" class="btn btn-info btn-xs">{!! tr('login_using_facebook') !!}</a>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 no-padding">
                        <div class="checkbox ">
                            ...
                            <label for="checkbox1">{!! tr("remember_me") !!}</label>
                        </div>
                    </div>
                    <div class="col-md-6 text-right">
                        <a href="{!! route('forgot_password') !!}" class="text-info small">{!! tr("forgot_password") !!}
                            ?</a>
                    </div>
                </div>
                <!-- END Form Control-->
                <button class="btn btn-primary btn-cons m-t-10" type="submit">{!! tr("login") !!}</button>
                <br>
                <div class="text-right">
                    <a href="{!! route('sign_up') !!}">{!! tr("do_not_have_an_account") !!}?</a>
                </div>
            </form>
            <!--END Login Form-->
        </div>
