...
<head>
    ...
    <link href="{!!url('theme_assets')!!}/assets/plugins/switchery/css/switchery.min.css" rel="stylesheet"
          type="text/css" media="screen"/>
    <link href="{!!url('theme_assets')!!}/assets/plugins/nvd3/nv.d3.min.css" rel="stylesheet" type="text/css"
          media="screen"/>
    <link href="{!!url('theme_assets')!!}/assets/plugins/mapplic/css/mapplic.css" rel="stylesheet" type="text/css"/>
    <link href="{!!url('theme_assets')!!}/assets/plugins/rickshaw/rickshaw.min.css" rel="stylesheet" type="text/css"/>
    <link href="{!!url('theme_assets')!!}/assets/plugins/bootstrap-datepicker/css/datepicker3.css" rel="stylesheet"
          type="text/css" media="screen">
    <link href="{!!url('theme_assets')!!}/assets/plugins/jquery-metrojs/MetroJs.css" rel="stylesheet" type="text/css"
          media="screen"/>
...
<!--[if lte IE 9]>
    ...
    <![endif]-->
    <!--[if lt IE 9]>
    <link href="{!!url('theme_assets')!!}/assets/plugins/mapplic/css/mapplic-ie.css" rel="stylesheet" type="text/css"/>
    <![endif]-->
...
<nav class="page-sidebar" data-pages="sidebar">
    ...
    <div class="sidebar-overlay-slide from-top" id="appMenu">
        <div class="row">
            <div class="col-xs-6 no-padding">
                <a href="{!!url('theme_assets')!!}/#" class="p-l-40"><img
                            src="{!!url('theme_assets')!!}/assets/img/demo/social_app.svg" alt="socail">
                </a>
            </div>
            <div class="col-xs-6 no-padding">
                <a href="{!!url('theme_assets')!!}/#" class="p-l-10"><img
                            src="{!!url('theme_assets')!!}/assets/img/demo/email_app.svg" alt="socail">
                </a>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-6 m-t-20 no-padding">
                <a href="{!!url('theme_assets')!!}/#" class="p-l-40"><img
                            src="{!!url('theme_assets')!!}/assets/img/demo/calendar_app.svg" alt="socail">
                </a>
            </div>
            <div class="col-xs-6 m-t-20 no-padding">
                <a href="{!!url('theme_assets')!!}/#" class="p-l-10"><img
                            src="{!!url('theme_assets')!!}/assets/img/demo/add_more.svg" alt="socail">
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="sidebar-header">
        <img src="{!!url('theme_assets')!!}/assets/img/logo_white.png" alt="logo" class="brand"
             data-src="{!!url('theme_assets')!!}/assets/img/logo_white.png"
    ...
    <div class="sidebar-menu">
        ...
        <ul class="menu-items">
            <li class="m-t-30 open">
                ...
                <span class="icon-thumbnail bg-success"><i class="fa fa-dashboard"></i></span>
            </li>
            <li class="">
                <a href="{!! route('publishing') !!}" class="detailed">
                    <span class="title">{!! trans('messages.publishing') !!}</span>
                </a>
                <span class="icon-thumbnail "><i class="fa fa-bullhorn"></i></span>
            </li>
            @if(count(\Auth::user()->getProfiles()))
                <li class="">
                    <a href="{!! route('watermark', \Auth::user()->profiles()->first()->id) !!}" class="detailed">
                        <span class="title">{!! trans('messages.watermark') !!}</span>
                    </a>
                    <span class="icon-thumbnail "><i class="fa fa-watermark"></i></span>
                </li>
            @endif
            <li class="">
                <a href="{!! route('feeds') !!}" class="detailed">
                    <span class="title">{!! trans('messages.feeds') !!}</span>
                </a>
                <span class="icon-thumbnail "><i class="fa fa-rss"></i></span>
            </li>
            <li class="">
                <a href="{!! route('app.settings') !!}" class="detailed">
                    <span class="title">{!! trans('messages.settings') !!}</span>
                </a>
                <span class="icon-thumbnail "><i class="fa fa-wrench"></i></span>
            </li>
            <li class="">
                <a href="{!! route('statistics') !!}" class="detailed">
    ...
    <div class="header ">
        ...
        <div class="pull-left full-height visible-sm visible-xs">
            ...
            <div class="sm-action-bar">
                <a href="{!!url('theme_assets')!!}/#" class="btn-link toggle-sidebar" data-toggle="sidebar">
        ...
        <div class="pull-right full-height visible-sm visible-xs">
            <!-- START ACTION BAR -->
            <div class="sm-action-bar">
                <a href="{!!url('theme_assets')!!}/#" class="btn-link" data-toggle="quickview"
            ...
            <div class="header-inner">
                ...
                <ul class="notification-list no-margin hidden-sm hidden-xs b-grey b-l b-r no-style p-l-30 p-r-20">
                    <li class="p-r-15 inline">
                        <div class="dropdown">
                            <a href="{!!url('theme_assets')!!}/javascript:;" id="notification-center"
                               class="icon-set globe-fill" data-toggle="dropdown">
                            ...
                            <div class="dropdown-menu notification-toggle" role="menu"
                                ...
                                <div class="notification-panel">
                                    ...
                                    <div class="notification-body scrollable">
                                        ...
                                        <div class="notification-item unread clearfix">
                                            ...
                                            <div class="heading open">
                                                <a href="{!!url('theme_assets')!!}/#" class="text-complete">
                                            ...
                                            <div class="option" data-toggle="tooltip" data-placement="left"
                                                 title="mark as read">
                                                <a href="{!!url('theme_assets')!!}/#" class="mark"></a>
                                            </div>
                                        ...
                                        <div class="notification-item  clearfix">
                                            <div class="heading">
                                                <a href="{!!url('theme_assets')!!}/#" class="text-danger">
                                                    <i class="fa fa-exclamation-{!! site_option("site_title")!!} m-r-10"></i>
                                        ...
                                        <div class="notification-item  clearfix">
                                            <div class="heading">
                                                <a href="{!!url('theme_assets')!!}/#" class="text-warning-dark">
                                                    <i class="fa fa-exclamation-{!! site_option("site_title")!!} m-r-10"></i>
                                            ...
                                            <div class="heading">
                                                <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                                                    <img width="30" height="30"
                                                         ...
                                                         data-src="{!!url('theme_assets')!!}/assets/img/profiles/1.jpg"
                                                         alt=""
                                                         src="{!!url('theme_assets')!!}/assets/img/profiles/1.jpg">
                                                </div>
                                                <a href="{!!url('theme_assets')!!}/#" class="text-complete">
                                    ...
                                    <div class="notification-footer text-center">
                                        <a href="{!!url('theme_assets')!!}/#" class="">Read all notifications</a>
                                        <a data-toggle="refresh" class="portlet-refresh text-black pull-right"
                                           href="{!!url('theme_assets')!!}/#">
                    ...
                    <li class="p-r-15 inline">
                        <a href="{!!url('theme_assets')!!}/#"><i class="fa fa-pencil"></i></a>
                    </li>
                </ul>
        ...
        <div class=" pull-right">
            ...
            <div class="visible-lg visible-md m-t-10">
                ...
                <img src="{!! \Auth::user()->getAvatar() !!}" alt=""
                     ...
                     data-src-retina="{!! \Auth::user()->getAvatar() !!}" width="32" height="32">
            </span>
                    </button>
                    <ul class="dropdown-menu profile-dropdown" role="menu">
                        <li><a href="{!!route('app.settings')!!}"><i
                                        class="pg-settings_small"></i> {!! trans('messages.settings') !!}</a>
                        </li>
                        <li class="bg-master-lighter">
                            <a href="{!!route('logout')!!}" class="clearfix">
                                <span class="pull-left">{!! trans('messages.logout') !!}</span>
        ...
        <div class="container-fluid container-fixed-lg footer">
            <div class="copyright sm-text-center">
                <p class="small no-margin pull-left sm-pull-reset">
                    ...
                    <span class="sm-block"><a href="{!!url('theme_assets')!!}/#" class="m-l-10 m-r-10">Terms of use</a> | <a
                                href="{!!url('theme_assets')!!}/#" class="m-l-10">Privacy Policy</a></span>
                </p>

                <p class="small no-margin pull-right sm-pull-reset">
                    <a href="{!!url('theme_assets')!!}/#">Hand-crafted</a> <span class="hint-text">&amp; Made with Love ®</span>
                </p>
...
<div id="quickview" class="quickview-wrapper" data-pages="quickview">
    ...
    <ul class="nav nav-tabs">
        <li class="">
            <a href="{!!url('theme_assets')!!}/#quickview-notes" data-toggle="tab">Notes</a>
        </li>
        <li>
            <a href="{!!url('theme_assets')!!}/#quickview-alerts" data-toggle="tab">Alerts</a>
        </li>
        <li class="active">
            <a href="{!!url('theme_assets')!!}/#quickview-chat" data-toggle="tab">Chat</a>
        </li>
    </ul>
            ...
            <div class="view-port clearfix quickview-notes" id="note-views">
                ...
                <div class="view list" id="quick-note-list">
                    <div class="toolbar clearfix">
                        <ul class="pull-right ">
                            <li>
                                <a href="{!!url('theme_assets')!!}/#" class="delete-note-link"><i
                                            class="fa fa-trash-o"></i></a>
                            </li>
                            <li>
                                <a href="{!!url('theme_assets')!!}/#" class="new-note-link" data-navigate="view"
                    ...
                    <ul>
                        ...
                        <li data-noteid="1">
                            ...
                            <div class="right pull-right">
                                ...
                                <a href="{!!url('theme_assets')!!}/#" data-navigate="view" data-view-port="#note-views"
                        ...
                        <li data-noteid="2">
                            ...
                            <div class="right pull-right">
                                <!-- BEGIN Note Date !-->
                                <span class="date">12/12/14</span>
                                <a href="{!!url('theme_assets')!!}/#"><i class="fa fa-chevron-right"></i></a>
                                <!-- END Note Date !-->
                            </div>
                            <!-- END Note Details !-->
                        </li>
                ...
                <div class="view note" id="quick-note">
                    <div>
                        <ul class="toolbar">
                            <li><a href="{!!url('theme_assets')!!}/#" class="close-note-link"><i
                                            class="pg-arrow_left"></i></a>
                            </li>
                            <li><a href="{!!url('theme_assets')!!}/#" data-action="Bold"><i class="fa fa-bold"></i></a>
                            </li>
                            <li><a href="{!!url('theme_assets')!!}/#" data-action="Italic"><i class="fa fa-italic"></i></a>
                            </li>
                            <li><a href="{!!url('theme_assets')!!}/#" class=""><i class="fa fa-link"></i></a>
                            </li>
                        </ul>
                        <div class="body">
                            <div>
                ...
                <div class="view bg-white">
                    ...
                    <div class="navbar navbar-default navbar-sm">
                        <div class="navbar-inner">
                            ...
                            <a href="{!!url('theme_assets')!!}/javascript:;"
                               class="inline action p-l-10 link text-master" data-navigate="view" data-view-port="#chat"
                            ...
                            <!-- BEGIN Header Controler !-->
                            <a href="{!!url('theme_assets')!!}/#"
                               class="inline action p-r-10 pull-right link text-master">
                                <i class="pg-search"></i>
                            </a>
                            <!-- END Header Controler !-->
                        </div>
                    ...
                    <div data-init-list-view="ioslist" class="list-view boreded no-top-border">
                        ...
                        <div class="list-view-group-container">
                            ...
                            <ul>
                                ...
                                <li class="alert-list">
                                    ...
                                    <a href="{!!url('theme_assets')!!}/javascript:;" class="" data-navigate="view"
                                ...
                                <li class="alert-list">
                                    <!-- BEGIN Alert Item Set Animation using data-view-animation !-->
                                    <a href="{!!url('theme_assets')!!}/#" class="" data-navigate="view"
                                       data-view-port="#chat" data-view-animation="push-parrallax">
                                        <p class="col-xs-height col-middle">
                                            <span class="text-warning fs-10"><i class="fa fa-circle"></i></span>
                                        </p>
                        ...
                        <div class="list-view-group-container">
                            ...
                            <ul>
                                ...
                                <li class="alert-list">
                                    <!-- BEGIN Alert Item Set Animation using data-view-animation !-->
                                    <a href="{!!url('theme_assets')!!}/javascript:;" class="p-t-10 p-b-10"
                        ...
                        <div class="list-view-group-container">
                            ...
                            <ul>
                                ...
                                <li class="alert-list">
                                    <!-- BEGIN Alert Item Set Animation using data-view-animation !-->
                                    <a href="{!!url('theme_assets')!!}/#" class="p-t-10 p-b-10" data-navigate="view"
                                       data-view-port="#chat" data-view-animation="push-parrallax">
                                        <p class="col-xs-height col-middle">
            ...
            <div class="view-port clearfix" id="chat">
                    ...
                    <div data-init-list-view="ioslist" class="list-view boreded no-top-border">
                            ...
                            <ul>
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view"
                                       class="" href="{!!url('theme_assets')!!}/#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/1x.jpg"
                                 data-src="{!!url('theme_assets')!!}/assets/img/profiles/1.jpg"
                                 src="{!!url('theme_assets')!!}/assets/img/profiles/1x.jpg" class="col-top">
                        </span>
                        </span>
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/2x.jpg"
                                 data-src="{!!url('theme_assets')!!}/assets/img/profiles/2.jpg"
                                 src="{!!url('theme_assets')!!}/assets/img/profiles/2x.jpg" class="col-top">
                        </span>
                        </span>
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/3x.jpg"
                                 data-src="{!!url('theme_assets')!!}/assets/img/profiles/3.jpg"
                                 src="{!!url('theme_assets')!!}/assets/img/profiles/3x.jpg" class="col-top">
                        </span>
                        </span>
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/4x.jpg"
                                 data-src="{!!url('theme_assets')!!}/assets/img/profiles/4.jpg"
                                 src="{!!url('theme_assets')!!}/assets/img/profiles/4x.jpg" class="col-top">
                        </span>
                        </span>
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/5x.jpg"
                                 data-src="{!!url('theme_assets')!!}/assets/img/profiles/5.jpg"
                                 src="{!!url('theme_assets')!!}/assets/img/profiles/5x.jpg" class="col-top">
                        </span>
                        </span>
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/6x.jpg"
                                 data-src="{!!url('theme_assets')!!}/assets/img/profiles/6.jpg"
                                 src="{!!url('theme_assets')!!}/assets/img/profiles/6x.jpg" class="col-top">
                        </span>
                        </span>
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/7x.jpg"
                                 data-src="{!!url('theme_assets')!!}/assets/img/profiles/7.jpg"
                                 src="{!!url('theme_assets')!!}/assets/img/profiles/7x.jpg" class="col-top">
                        </span>
                        </span>
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/8x.jpg"
                                 data-src="{!!url('theme_assets')!!}/assets/img/profiles/8.jpg"
                                 src="{!!url('theme_assets')!!}/assets/img/profiles/8x.jpg" class="col-top">
                        </span>
                        </span>
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/9x.jpg"
                                 data-src="{!!url('theme_assets')!!}/assets/img/profiles/9.jpg"
                                 src="{!!url('theme_assets')!!}/assets/img/profiles/9x.jpg" class="col-top">
                        </span>
                        </span>
                ...
                <div class="view chat-view bg-white clearfix">
                    ...
                    <div class="navbar navbar-default">
                        <div class="navbar-inner">
                            <a href="{!!url('theme_assets')!!}/javascript:;"
                               class="link text-master inline action p-l-10 p-r-10" data-navigate="view"
                               data-view-port="#chat" data-view-animation="push-parrallax">
                            ...
                            <a href="{!!url('theme_assets')!!}/#"
                               class="link text-master inline action p-r-10 pull-right ">
                                <i class="pg-more"></i>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="message clearfix">
                            <div class="profile-img-wrapper m-t-5 inline">
                                <img class="col-top" width="30" height="30"
                                     src="{!!url('theme_assets')!!}/assets/img/profiles/avatar_small.jpg" alt=""
                                     data-src="{!!url('theme_assets')!!}/assets/img/profiles/avatar_small.jpg"
                    ...
                    <div class="b-t b-grey bg-white clearfix p-l-10 p-r-10">
                        <div class="row">
                            <div class="col-xs-1 p-t-15">
                                <a href="{!!url('theme_assets')!!}/#" class="link text-master"><i
                            ...
                            <div class="col-xs-2 link text-master m-l-10 m-t-15 p-l-10 b-l b-grey col-top">
                                <a href="{!!url('theme_assets')!!}/#" class="link text-master"><i class="pg-camera"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- END Chat Input  !-->
...
<div class="overlay hide" data-pages="search">
    ...
    <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
            <!-- BEGIN Overlay Logo !-->
            <img class="overlay-brand" src="{!!url('theme_assets')!!}/assets/img/logo.png" alt="logo"
                 data-src="{!!url('theme_assets')!!}/assets/img/logo.png" data-src-retina="assets/img/logo_2x.png"
                 width="78" height="22">
            <!-- END Overlay Logo !-->
            <!-- BEGIN Overlay Close !-->
            <a href="{!!url('theme_assets')!!}/#" class="close-icon-light overlay-close text-black fs-16">
                <i class="pg-close"></i>
            </a>
            <!-- END Overlay Close !-->
        </div>
                            ...
                            <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                                <div>
                                    <img width="50" height="50"
                                         src="{!!url('theme_assets')!!}/assets/img/profiles/avatar.jpg"
                                         data-src="{!!url('theme_assets')!!}/assets/img/profiles/avatar.jpg"
...
<script src="{!!url('theme_assets')!!}/assets/plugins/nvd3/lib/d3.v3.js" type="text/javascript"></script>
<script src="{!!url('theme_assets')!!}/assets/plugins/nvd3/nv.d3.min.js" type="text/javascript"></script>
<script src="{!!url('theme_assets')!!}/assets/plugins/nvd3/src/utils.js" type="text/javascript"></script>
<script src="{!!url('theme_assets')!!}/assets/plugins/nvd3/src/tooltip.js" type="text/javascript"></script>
<script src="{!!url('theme_assets')!!}/assets/plugins/nvd3/src/interactiveLayer.js" type="text/javascript"></script>
<script src="{!!url('theme_assets')!!}/assets/plugins/nvd3/src/models/axis.js" type="text/javascript"></script>
<script src="{!!url('theme_assets')!!}/assets/plugins/nvd3/src/models/line.js" type="text/javascript"></script>
<script src="{!!url('theme_assets')!!}/assets/plugins/nvd3/src/models/lineWithFocusChart.js"
        type="text/javascript"></script>
<script src="{!!url('theme_assets')!!}/assets/plugins/mapplic/js/hammer.js"></script>
<script src="{!!url('theme_assets')!!}/assets/plugins/mapplic/js/jquery.mousewheel.js"></script>
<script src="{!!url('theme_assets')!!}/assets/plugins/mapplic/js/mapplic.js"></script>
<script src="{!!url('theme_assets')!!}/assets/plugins/rickshaw/rickshaw.min.js"></script>
<script src="{!!url('theme_assets')!!}/assets/plugins/jquery-metrojs/MetroJs.min.js" type="text/javascript"></script>
<script src="{!!url('theme_assets')!!}/assets/plugins/jquery-sparkline/jquery.sparkline.min.js"
        type="text/javascript"></script>
<script src="{!!url('theme_assets')!!}/assets/plugins/skycons/skycons.js" type="text/javascript"></script>
<script src="{!!url('theme_assets')!!}/assets/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js"
        type="text/javascript"></script>
<!-- END VENDOR JS -->
